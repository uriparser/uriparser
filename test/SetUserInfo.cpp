...
TEST(IsWellFormedUserInfo, PercentEncodingWellFormed) {
	testIsWellFormedUserInfo("%" "aa" "%" "AA", true);
}
...
TEST(SetUserInfo, UriWithoutHostNonNullRejected) {
	...
	EXPECT_EQ(uriSetUserInfoA(&uri, first, afterLast), URI_ERROR_SETUSERINFO_HOST_NOT_SET);
